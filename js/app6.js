...
new fullpage("#fullpage", {
  ...
  onLeave: (origin, destination, direction) => { 
    ...
    if (destination.index === 2 && swiper.activeIndex === 0  ) {  
     ...
     setTimeout(function(){
      document.getElementById("mask321").classList.add("animate__zoomInLeft");
      ...
      setTimeout(function(){
        document.getElementById("text321").classList.add("animate__flipInY");
 ...
 zoom: false,
  ...
  on: {
    slideChange: function(){
      ...
      document.getElementById("text321").classList.remove("animate__flipInY");
      document.getElementById("mask321").classList.remove("active");
      document.getElementById("mask321").classList.remove("animate__zoomInLeft");
...
intensity: 0.1,
angle: Math.PI / 4,
image1: "img/design1212.png",
image2: "img/design2121.png",
